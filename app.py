    ...
    def predict_stock_prices(data, days, model_type):
        ...
        if model_type == "ARIMA":
            # ARIMA Model
            # Ensure y is a 1D array for ARIMA
            y_arima = data['Close'].values
            
            try:
                model = ARIMA(y_arima, order=(5, 1, 0))
                model_fit = model.fit()
            ...
            if len(scaled_data) <= time_step:
                st.error("Not enough data to train LSTM (Need more than 60 days).")
                return [], []
    ...
    def main():
        ...
        with st.sidebar:
            ...
            # CHANGED: Model selection now only includes ARIMA and LSTM
        ...
        if st.session_state.predict_clicked:
            try:
                ...
                if data.empty:
                    ...
                    # Add a spinner because LSTM/ARIMA can take a moment
                    ...
                    if len(predictions) > 0:
                        ...
                        # Ensure current_price is numeric for sentiment analysis
                        try:
                        ...
                        # Huge list of tickers preserved from user code
